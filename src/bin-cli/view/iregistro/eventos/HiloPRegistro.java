...
public class HiloPRegistro implements Runnable{
    ...
    public void run() {
        try {
            ...
            int codigo = (int) Config.pControl.pPeritos.modelRegistros.getValueAt(Config.pControl.pPeritos.tabRegistros.getSelectedRow(), 0);
            ...
            Config.error("Seleccione un Registro de la tabla de registros.");
        }
    }
}
