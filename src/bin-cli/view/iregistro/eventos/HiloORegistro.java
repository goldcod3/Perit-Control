...
public class HiloORegistro implements Runnable{
    ...
    public void run() {
        try {
            ...
            int codigo = (int) Config.pControl.pControl.modelRegistro.getValueAt(Config.pControl.pControl.tabRegistro.getSelectedRow(), 0);
            ...
            Config.error("Seleccione un Registro de la tabla de registros activos.");
        }
    }
